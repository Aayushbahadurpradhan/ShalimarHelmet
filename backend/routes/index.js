...
// router.get('/audit/logs', fetchAllAuditLogs);

// // Route to get audit logs by userId
// router.get('/audit/logs/user/:userId', fetchAuditLogsByUserId);

// // Route to get audit logs by action
// router.get('/audit/logs/action/:action', fetchAuditLogsByAction);
